...
/// Name of the local Holium area directory.
pub(crate) const LOCAL_DIR: &'static str = "local";
/// Name of the portions file.
pub(crate) const PORTATIONS_FILE: &'static str = "portations";
