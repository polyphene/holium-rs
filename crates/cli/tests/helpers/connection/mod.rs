...
pub(crate) const SOURCE_TYPE: &'str str = "source";
pub(crate) const TRANSFORMATION_TYPE: &'str str = "transformation";
pub(crate) const SHAPER_TYPE: &'str str = "shaper";
...
pub(crate) const CONNECTION_ID: &'static str = SOURCE_TYPE+
...
/// Same as [setup_repo] but with a connection already created
